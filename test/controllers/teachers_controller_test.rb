...
class TeachersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teacher" do
    assert_difference('Teacher.count') do
      post teachers_url, params: { teacher: { Department: @teacher.Department, Name: @teacher.Name } }
    end
  ...
  test "should update teacher" do
    patch teacher_url(@teacher), params: { teacher: { Department: @teacher.Department, Name: @teacher.Name } }
